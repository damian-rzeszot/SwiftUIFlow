...
final class CoordinatorPresentationTests: XCTestCase {
    ...
    func test_CanPresentAndDismissModalCoordinator() {
        ...
        sut.coordinator.presentModal(modal, presenting: .home, detentConfiguration: ModalDetentConfiguration(detents: [.large]))
    ...
    func test_NavigateDismissesModalWhenModalCantHandle() {
        ...
        sut.coordinator.presentModal(modal, presenting: .modal, detentConfiguration: ModalDetentConfiguration(detents: [.large]))
